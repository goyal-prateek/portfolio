        ...
        <div className="min-w-0">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:gap-6">
            <div className="flex shrink-0 justify-center sm:justify-start">
              <Avatar className="animate-avatar size-28 sm:size-32 md:size-36" />
            </div>
            <div className="min-w-0 flex-1 text-center sm:pt-1 sm:text-left">
              ...
              <p className="animate-hero animate-hero-delay-3 mt-2 flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-sm text-(--muted-foreground) sm:justify-start">
          ...
          <p className="animate-hero animate-hero-delay-4 mx-auto mt-6 max-w-[min(100%,65ch)] text-pretty text-base leading-relaxed text-(--muted-foreground) sm:mx-0">
            {site.headline}
          </p>
