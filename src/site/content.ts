  ...
  toyProjects: [
    {
      slug: "slap-my-mac",
      title: "Slap My Mac",
      subtitle: "Menu bar app for Apple Silicon MacBooks",
      description:
      ...
      repo: "https://github.com/goyal-prateek/slap-my-mac",
      logoSrc: "/toy-projects/slap-my-mac/slap-my-mac-logo.png",
      note: "Apple Silicon for the motion sensor; other Macs can still use test slap and audio settings.",
    },
  ],
  profilesIntro:
